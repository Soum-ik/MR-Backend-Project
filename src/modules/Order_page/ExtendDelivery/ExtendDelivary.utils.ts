...
async function updateDeliveryDate(orderData: OrderData, days: number): Promise<UpdateDeliveryDateResult> {
    try {
        if (!orderData) {
        ...
        const totalDurationHours = parseInt(orderData.durationHours || '0', 10) + hours;
