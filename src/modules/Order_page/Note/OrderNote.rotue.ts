...
OrderNoteRouter.delete("/delete-order-note/:orderId/:noteId", authenticateToken(USER_ROLE.ADMIN, USER_ROLE.SUPER_ADMIN, USER_ROLE.SUB_ADMIN, USER_ROLE.USER), OrderNoteController.DeleteOrderNote);
